export const preloadData = async (apiKey, userId) => {
  try {
    ...
    const signalData = await fetch("http://admin.tducoin.com/api/signal", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
    ...
    const channelData = await fetch("http://admin.tducoin.com/api/signal/channel", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const quizData = await fetch("http://admin.tducoin.com/api/quiz", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const newsData = await fetch("http://admin.tducoin.com/api/news", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const userData = await fetch(`http://admin.tducoin.com/api/webappuser/${userId}`, {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const courseData = await fetch(`http://admin.tducoin.com/api/course/${userId}`, {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const charityData = await fetch("http://admin.tducoin.com/api/charity", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
    ...
    const giftData = await fetch("http://admin.tducoin.com/api/gift", {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
        "Content-Type": "application/json",
